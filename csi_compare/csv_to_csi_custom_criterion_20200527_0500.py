...
csi_CREF = np.loadtxt(open(save_path+"/202005270500to12(Hehuan Mountain)_01to06_CREF.csv","rb"), delimiter=",", skiprows=0)
csi_HPRNN = np.loadtxt(open(save_path+"/202005270500to12(Hehuan Mountain_128)_01to06.csv","rb"), delimiter=",", skiprows=0)
...
fig.savefig(fname=save_path+'/'+date+'_AVG_CSI_to6.png', format='png')
plt.clf()

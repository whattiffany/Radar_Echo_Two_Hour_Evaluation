...
csi_predrnn_loss_atten = np.loadtxt(open(save_path+"60&120min/202106060200to6__pred_attn.csv","rb"), delimiter=",", skiprows=0)
csi_CREF = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12_cref.csv","rb"), delimiter=",", skiprows=0)
csi_new_weight2 = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12(mse).csv","rb"), delimiter=",", skiprows=0)
csi_new_weight3 = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12(bmse).csv","rb"), delimiter=",", skiprows=0)
csi_new_weight4 = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12(bmse+cbam).csv","rb"), delimiter=",", skiprows=0)
csi_new_weight5 = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12(mse+cbam).csv","rb"), delimiter=",", skiprows=0)
csi_new_weight6 = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12(bmse+cbam)w1.csv","rb"), delimiter=",", skiprows=0)
csi_new_weight7 = np.loadtxt(open(save_path+"60&120min/202106060200to12_07to12(bmse+cbam)w2.csv","rb"), delimiter=",", skiprows=0)

# csi_MLC = np.loadtxt(open("MLC_{}/csi.csv","rb"), delimiter=",", skiprows=0)
# csi_PredRNN = np.loadtxt(open(save_path+"202106060200to6_predrnn_loss_atten_v2.csv","rb"), delimiter=",", skiprows=0)
# csi_PredRNN_loss = np.loadtxt(open(save_path+"202106060200to6_predrnn_loss.csv","rb"), delimiter=",", skiprows=0)
# csi_predrnn_atten = np.loadtxt(open(save_path+"60&120min/202106060200to6__pred_attn.csv","rb"), delimiter=",", skiprows=0)

# csi_ConvLSTM = np.loadtxt(open(save_path+"202106060200to6_convlstm.csv","rb"), delimiter=",", skiprows=0)
# csi_ConvLSTM_loss = np.loadtxt(open(save_path+"202106060200to6_convlstm_loss.csv","rb"), delimiter=",", skiprows=0)
...
# plt.plot(np.arange(csi_predrnn_loss_atten.shape[1]), [np.nan] + np.mean(csi_predrnn_loss_atten[:, 1:], 0).tolist(), c='limegreen', linewidth=2.0, label='DA-LSTM(b-mse)')
...
plt.plot(np.arange(csi_new_weight7.shape[1]), [np.nan] + np.mean(csi_new_weight7[:, 1:], 0).tolist(), c='mediumblue', linewidth=2.0, label='HPRNN_CBAM(b-mse 3 Groups)')
...
fig.savefig(fname=save_path+'60&120min/Thresholds_AVG_CSI_to12_cbam3.png', format='png')
plt.clf()

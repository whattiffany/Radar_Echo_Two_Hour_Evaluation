...
csi_CREF = np.loadtxt(open(save_path+"/202106060300to12(Shangdewen)_01to06_CREF.csv","rb"), delimiter=",", skiprows=0)
csi_HPRNN = np.loadtxt(open(save_path+"/202106060300to12_01to06.csv","rb"), delimiter=",", skiprows=0)

...
#m.plot(x7, y7, marker = '.', color = 'r')
##plt.text(x7, y7, 'Dawu')
#
#x8, y8 = m(120.7383, 22.0057)
#m.plot(x8, y8, marker = '.', color = 'r')
...
#m.plot(x11, y11, marker = '.', color = 'r')
##plt.text(x11, y11, 'Taitung')
#
#x12, y12 = m(120.5152, 24.2578)
#m.plot(x12, y12, marker = '.', color = 'r')
...
m.plot(x20, y20, marker = 'D', color = 'r')

...
def visualized_area_with_map(radar, place, shape_size=[105, 105], title='', savepath=None, terrain=False):
    ...
    llcrnrlat = area_20[place].lat - 0.0125*(shape_size[0]//2)
...
if __name__ == "__main__":
    ...
    gz = gzip.open("CREF/CREF_060min.20180824.005000.gz").read()
#    D:\research_CREF\research_new\CREF
#    CREF_060min.20180824.005000.gz
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [55, 55], title='201808240500.0060', savepath=save_path)
    
    '''
    gz = gzip.open("NWP/2020_05/COMPREF_OBS_FCST/CREF_010min/CREF_010min.20200527.000000.gz").read()
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [315, 315], title='20180824.0010', savepath=save_path)
    
    gz = gzip.open("NWP/2020_05/COMPREF_OBS_FCST/CREF_020min/CREF_020min.20200527.000000.gz").read()
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [315, 315], title='20180824.0020', savepath=save_path)
    
    gz = gzip.open("NWP/2020_05/COMPREF_OBS_FCST/CREF_030min/CREF_030min.20200527.000000.gz").read()
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [315, 315], title='20180824.0030', savepath=save_path)
    
    gz = gzip.open("NWP/2020_05/COMPREF_OBS_FCST/CREF_040min/CREF_040min.20200527.000000.gz").read()
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [315, 315], title='20180824.0040', savepath=save_path)
    
    gz = gzip.open("NWP/2020_05/COMPREF_OBS_FCST/CREF_050min/CREF_050min.20200527.000000.gz").read()
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [315, 315], title='20180824.0050', savepath=save_path)
    
    gz = gzip.open("NWP/2020_05/COMPREF_OBS_FCST/CREF_060min/CREF_060min.20200527.000000.gz").read()
    radar = np.array(struct.unpack(1501*1501*'h', gz[-1501*1501*2:])).reshape(1501, 1501).astype(np.float64)/10
    print(radar)
    print(np.array(radar).shape)
    visualized_area_with_map(radar, 'Sun_Moon_Lake', [315, 315], title='20180824.0100', savepath=save_path)

...
#                                   ['2018-05-01 00:00', '2018-11-30 23:59']],
        ...
        self._date_ranged_to60 = self._buildSourceDateRange_to60()
    ...
    def _buildDateRange_to60(self, date_range):
        """Turn string format datetime to datetime format list"""
        date_range_temp = []
        for date in date_range:
            date_range_temp += pd.date_range(date[0], date[1], freq='60T').tolist()
    ...
    def _buildSourceDateRange_to60(self):
        """Turn string format datetime to datetime format list for source data"""
        date_range = np.vstack((self._date_range, self._test_date))
        date_range_temp = []
        print("date_range")
        ...
        for date in date_range:
            ...
            date_start = datetime.strptime(date[0], "%Y-%m-%d %H:%M") - timedelta(minutes=10*self._period)
            date_end = datetime.strptime(date[-1], "%Y-%m-%d %H:%M") + timedelta(minutes=10*(self._predict_period-1))
            date_range_temp += pd.date_range(date_start, date_end, freq='60T').tolist()
            print(len(date_range_temp),date_start,"to",date_end)
        print("====")
    ...
    def _buildRadarEchoFileList(self):
        ...
        if os.path.isdir(self._radar_echo_storage_path):
            # sp = ShowProcess(len(self._radar_echo_storage_path))
            ...
            file_list = []
            print("Building Radar Echo file_list_temp...")
...
#            print("place in"+place+"x is"+xy['x']+'y is'+xy['y'])
        ...
        for  place,xy in self._places_dict.items():
            ...
            print(self._radar_echo_df) 
            self._radar_echo_df.to_csv("radar_echo_df_0529.csv",header='true')
    ...
    def _createDataSetSequence(self):
        ...
        # print("self._date_ranged_to60=",self._date_ranged_to60)
...
#            data.close()
    ...
    def _testValDatetimeExtract(self):
        ...
        train_date_range = self._buildDateRange_to60(self._date_range)#_to60)
        ...
        # print(self._train_val_radar_echo_seq_df.info())
        # print(self._train_val_radar_echo_seq_df) 
        # self._train_val_radar_echo_seq_df.to_excel(save_path+"train_drop1800_529.xlsx")
        '''
        ...
        # self._train_val_radar_echo_seq_df = shuffle(self._train_val_radar_echo_seq_df) #2020泛化測試註解 要改回來!!
        # self._train_val_radar_echo_seq_df.to_excel(save_path+"train_val_radar_echo_seq_df_shuffle.xlsx") #2020泛化測試註解 要改回來!!
...
#        self._radar_echo_df_path = path + '{}_RadarEcho_{}x{}.pkl'.format(self._place1, self._place2, self._place3, self._place4, self._place5, self._place6, self._place7, self._input_shape[0], self._input_shape[1])
    ...
    def generator(self, type='train', batch_size=32, save_path='/day'):
        ...
        if not os.path.isdir(save_path):
            os.makedirs(save_path)
        if type == 'train':
            self._radar_echo_df.to_excel(save_path+"train_radar_echo_df_generator.xlsx")
            print("self._train_radar_echo_seq_df.info()  drop test=")
            print(self._train_radar_echo_seq_df.info())
            print(self._train_radar_echo_seq_df)
            self._train_radar_echo_seq_df.to_excel(save_path+"train_radar_echo_seq_df_generator.xlsx")
...
#                      test_date=[['2018-08-27 00:00', '2018-08-27 23:59']])
    year = [
    # ['2020-02-01 00:00','2020-02-29 23:59'],
    # ['2020-03-01 00:00','2020-03-31 23:59'],
    # ['2020-04-01 00:00','2020-04-30 23:59'],
    # ['2020-05-01 00:00','2020-05-31 23:59'],
    # ['2020-06-01 00:00','2020-06-30 23:59'],
    # ['2020-07-01 00:00','2020-07-31 23:59'],
    # ['2020-08-01 00:00','2020-08-31 23:59'],
    # ['2020-09-01 00:00','2020-09-30 23:59'],
    # ['2020-10-01 00:00','2020-10-31 23:59'],
    # ['2020-11-01 00:00','2020-11-30 23:59'],
    # ['2020-12-01 00:00','2020-12-31 23:59']
    ['2021-01-01 00:00','2021-01-31 23:59']

    ]
    # date_date=[['2020-02-01 00:00','2020-02-29 23:59']]
    ...
    # data = load_data(radar_echo_storage_path='E:/yu_ting/predrnn/2019_9_19/NWP/CPLmaster/2017/', 
    for i in range(len(year)):
        data = load_data(radar_echo_storage_path='J:/2020_202106', 
                        load_radar_echo_df_path=None,#'data/RadarEcho_Bao_Zhong_2018_08240010_T6toT6_inoutputshape64_random.pkl',#None,#load_radar_echo_df_path,
        ...
        data.saveRadarEchoDataFrame(path=save_path,load_name_pkl='2021_{}'.format(i+1))
    end = time()

...
class load_data_CREF(object):
    ...
    def _buildSourceDateRange(self):
        ...
        for date in date_range:
            date_start = datetime.strptime(date[0], "%Y-%m-%d %H:%M") #- timedelta(minutes=10*self._period) #60分鐘一筆
...
#                    print(file_list)
    ...
    #                    print(file_list)
                ...
                self._radar_echo_df.to_excel('createRadarEchoDict_CREF_{}_5m9d.xlsx'.format(i))
                radar_echo = []
                destory_datetime = []
                print("Radar Echo loading...")
                if all_df:
                ...
                if i == 1:
                    ...
                    self._radar_echo_df_no_path.insert(6, '070', radar_echo)
                    self._radar_echo_df_no_path.to_excel('{}7_CREF.xlsx'.format(str(place)))
                    self._radar_echo_df_no_path.drop([val[0] for val in destory_datetime])
                    print("Loading finished!")
                elif i == 7:
                    print("i = ", i)
                    ...
                    self._radar_echo_df_no_path.insert(7, '080', radar_echo)
                    self._radar_echo_df_no_path.to_excel('{}8_CREF.xlsx'.format(str(place)))
                    self._radar_echo_df_no_path.drop([val[0] for val in destory_datetime])
                    print("Loading finished!")
                elif i == 8:
                    print("i = ", i)
                    ...
                    self._radar_echo_df_no_path.insert(8, '090', radar_echo)
                    self._radar_echo_df_no_path.to_excel('{}8_CREF.xlsx'.format(str(place)))
                    self._radar_echo_df_no_path.drop([val[0] for val in destory_datetime])
                    print("Loading finished!")
                elif i == 9:
                    ...
                    self._radar_echo_df_no_path.insert(9, '100', radar_echo)
                    self._radar_echo_df_no_path.to_excel('{}9_CREF.xlsx'.format(str(place)))
                    self._radar_echo_df_no_path.drop([val[0] for val in destory_datetime])
                    print("Loading finished!")
                elif i == 10:
                    print("i = ", i)
                    ...
                    self._radar_echo_df_no_path.insert(10, '110', radar_echo)
                    self._radar_echo_df_no_path.to_excel('{}10_CREF.xlsx'.format(str(place)))
                    self._radar_echo_df_no_path.drop([val[0] for val in destory_datetime])
                    print("Loading finished!")
                elif i == 11:
                    print("i = ", i)
                    ...
                    self._radar_echo_df_no_path.insert(11, '120', radar_echo)
                    self._radar_echo_df_no_path.to_excel('{}11_CREF.xlsx'.format(str(place)))
                    self._radar_echo_df_no_path.drop([val[0] for val in destory_datetime])
                    print("Loading finished!")
        ...
        all_place_df.to_excel('p20_CREF_1to12.xlsx')
...
#            self._radar_echo_df.drop([val[0] for val in destory_datetime])
    ...
    def saveRadarEchoDataFrame(self, path='data/',load_name_pkl='default'):
        ...
        self._radar_echo_df_all_path = path +  '{}.pkl'.format(load_name_pkl)
    ...
    def generator(self, type='train', batch_size=32):
        """Create generator"""
        if type == 'train':
            return generator(radar_echo_dataframe=self.all_place_df,

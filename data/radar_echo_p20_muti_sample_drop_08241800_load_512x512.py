...
#            data.close()
    ...
    def _testValDatetimeExtract(self):
        ...
        # self._train_val_radar_echo_seq_df = shuffle(self._train_val_radar_echo_seq_df) #! 0906 註解
        # self._train_val_radar_echo_seq_df.to_excel(save_path+"train_val_radar_echo_seq_df_shuffle.xlsx") #! 0906 註解
...
#                     place7='BaoZhong',
    ...
    save_path = 'Result/CREF/T6tT6/512x512/'
    if not os.path.isdir(save_path):
        os.makedirs(save_path)
    data.exportRadarEchoFileList()
    data.saveRadarEchoDataFrame(path=save_path,load_name_pkl='CREF_{}_640x640'.format('2020_01'))
